...
# ==== Команда /add — добавить сотрудника (только для админов) ====
...
# ==== Команда /remove — удалить сотрудника (только для админов) ====
...
# ==== Команда /setwelcome — изменить приветствие (только для админов) ====
...
# ==== Команда /setfollowup — изменить отложенное сообщение (только для админов) ====
...
# ==== Команда /addadmin — добавить админа (только для админов) ====
